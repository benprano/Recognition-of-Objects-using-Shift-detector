    ...
    for path, dirs, files in os.walk(dataset_path):
        for file in files:
            if fnmatch.fnmatch(file, '*.png'):
                ...
                sift = cv2.xfeatures2d.SIFT_create(number_descriptor)
...
predict('test/object10/obj10__260.png', show=True)
#write_classes_unique()
#test(dataset_path="./test")
# decriptor_test_image('model_keypoints/keypoints')
